...
><link href="styles/output.css" rel="stylesheet" /><link
  ...
  rel="stylesheet"
/><link href="./img/favi.webp" rel="icon" type="image/x-icon" /><link
...
<body class="uppercase bg-[#fcfcf3] font-oswald" data-section="home">
  <div id="splash"><p id="greeting"></p></div>
      ...
      >
        ...
        <div class="right-box hidden sm:inline-block">
          <a href="#contact" class="inline-block"
            ...
            >
              <span
                class="uppercase tracking-widest btnSpan font-extralight md:font-light md:text-2xl sm:text-xl text-base"
        ...
        <div class="w-full border-b-2 border-black border-t-2 about-box">
          ...
          >
            <a
              ...
              <span
                class="flex items-center justify-center transition-all absolute duration-500 ease-out group-hover:opacity-100 group-hover:translate-y-0 inset-0 md:scale-y-150 opacity-0 text-[#b3ac9e] transform translate-y-2 uppercase xl:scale-y-200"
                >about
              </span></a
            ><a
  ...
  <section class="flex flex-col w-full overflow-hidden" id="profile">
    ...
    >
      <div
        ...
        data-tx="0"
      >
        <span class="px-2 md:px-4">profile</span
    ...
    <div class="pl-10 md:my-24 md:pl-32 my-20">
      ...
      >
        hey, i'm a Graphic designer and web developer..<br />i love building
        Amazing Graphic content for startups, scale ups & agencies.<br />I help
        companies from all over the world with tailor-made solutions.<br />I
        always putting quality first.<br />I am here to make you look amazing!
      </p>
    </div>
    <div
      class="w-full overflow-hidden backgroundColorAllbrown h-14 md:h-20 top-0"
    ...
    >
      <div
        ...
        data-tx="0"
      >
        <span class="px-2 md:px-4">skills</span
        ><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span
        ><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span
  ...
  <section class="w-full relative snap-start" id="skills">
    ...
    >
      ...
      >
        ...
        <p
          class="transition-transform duration-[1500ms] ease-in-out opacity-0 transform transition-opacity translate-x-[270px]"
        >
          Advertising design
        </p>
        <p
          class="transition-transform duration-[1500ms] ease-in-out opacity-0 transform transition-opacity translate-x-[300px]"
        >
          Ui/Ux design
        </p>
        <p
          class="transition-transform duration-[1500ms] ease-in-out opacity-0 transform transition-opacity translate-x-[330px]"
        >
          Visual identity design
        </p>
        <p
          class="transition-transform duration-[1500ms] ease-in-out opacity-0 transform transition-opacity translate-x-[360px]"
        >
          Typography design
        </p>
      </div>
      <div class="relative" id="hero-container">
        ...
        >
          <div
            class="absolute rounded-full bg-black duration-75 md:h-3 md:w-3 pupil transition-transform h-3 w-3"
          ></div>
        </div>
        <div
  ...
  >
    <div
      ...
      data-tx="0"
    >
      <span class="px-2 md:px-4">project</span
      ><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span
      ><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity"
            >Logo </span
          ><span
            ...
            >Professional logo design reflects the brand's values and identity
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          ...
          ><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10"
            >Social media has become a captivating battleground for brands,
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity"
            >Banner and Billboard </span
          ><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10"
            >Billboards are powerful advertising tools that allow businesses to
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          ...
          ><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10"
            >Website design is the art of crafting a digital experience that
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          ...
          ><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10"
            >In a competitive and saturated marketplace, I elevate your brand
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          ...
          ><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10"
            >A creative and engaging design not only captures attention but also
      ...
      >
        ...
        <div class="z-10 relative ProjectAll pl-10">
          ...
          ><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10"
            >Professional packaging is the key to protecting a product and
    ...
    >
      ...
      ><button class="absolute text-white text-4xl left-4" id="lightbox-prev">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          height="80"
  ...
  <div class="w-full overflow-hidden h-14 md:h-20 top-0" id="scroll-pin">
    ...
    >
      <span class="px-2 md:px-4">-</span
      ><span class="px-2 md:px-4">contact</span
      ><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span
      ><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span
  ...
  >
    ...
    <div class="flex justify-center w-full max-w-4xl pb-16 space-x-4">
      <a
        ...
        class="flex items-center justify-center overflow-hidden ease-in-out relative bg-[#3f3b37] border border-transparent duration-500 hover:animate-shake hover:bg-[#d13318] magnetic rounded-full transition-[border-color,border-width]"
        ><span
          class="absolute duration-1000 transition-all bg-radial-red inset-0 opacity-0 scale-0 z-0"
        ></span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
      ...
      ><a
        ...
        class="flex items-center justify-center overflow-hidden ease-in-out relative bg-[#3f3b37] border border-transparent duration-500 hover:animate-shake hover:bg-[#d13318] magnetic rounded-full transition-[border-color,border-width] text-white"
        ><span
          class="absolute duration-1000 transition-all bg-radial-red inset-0 opacity-0 scale-0 z-0"
        ></span>
        <svg
    ...
    <a href="#hero"
      ...
      >
        <div
          ...
          id="scroll-footer"
        >
          <span class="px-2 md:px-8">back to top</span
          ><span class="px-2 md:px-8">-</span>
          <span class="px-2 md:px-8">back to top</span
          ><span class="px-2 md:px-8">-</span>
          <span class="px-2 md:px-8">back to top</span
          ><span class="px-2 md:px-8">-</span>
