...
<link
  href="./font/Oswald-Light.woff"
  rel="preload"
  type="font/woff2"
  as="font"
  crossorigin="anonymous" />
<link
  href="./font/Oswald-Light.woff2"
  rel="preload"
  type="font/woff2"
  as="font"
  crossorigin="anonymous" />
...
<body class="uppercase bg-[#fcfcf3] font-oswald" data-section="home">
  ...
  <div class="hidden bg-[#fcfcf3]" id="main-content">
    <section
      class="flex bg-[#fcfcf3] flex-col home-hero md:h-screen overflow-hidden w-full"
      id="home">
      <section
        class="flex items-start pt-10 2xl:pt-28 2xl:px-56 basis-[30%] justify-between lg:pt-20 lg:px-28 md:pt-20 md:px-20 px-6 sm:pt-20 sm:px-10 w-full xl:pt-28 xl:px-32"
        id="hero">
        <div class="left-box">
          <h2
            class="cursor-default select-none md:text-2xl pt-1 font-normal text-black text-xl">
            gohar hossein zadeh | dubai
          </h2>
        </div>
        <div class="right-box hidden sm:inline-block">
          <a href="#contact" class="inline-block">
            ...
            <button
              class="w-full backgroundButton md:p-2 p-1 rounded-2xl text-white"
              id="myButton">
              <span
                class="uppercase tracking-widest btnSpan font-extralight md:font-light md:text-2xl sm:text-xl text-base">Start a Project</span>
            </button>
          </a>
        </div>
      </section>
      <section class="w-full" id="features">
        <div class="feature-section h-full justify-center sm:flex sm:flex-col">
          <div
            class="flex items-center justify-center 2xl:px-32 feature-image lg:px-28 sm:grid sm:items-end w-full"
            style="grid-template-columns: 40% 20% 40%">
            <div class="sm:justify-center hidden sm:flex">
              <p
                class="cursor-default select-none font-light md:text-2xl 2xl:text-4xl colored heading-1 lg:text-3xl scale-y-250 sm:text-xl text-lg whitespace-nowrap 2xl:pb-5 lg:pb-3 md:tracking-wide pb-1 sm:pb-1.5"
                data-w-id="creative">
            ...
            <div class="inline-block relative mx-auto" id="hero-container">
              <img
                alt="Hero Image"
                class="block rounded-full sm:mx-auto"
                src="./img/Me.webp"
                id="hero-img" />
              <div>
                <img
              ...
              <div
                ...
                <div
                  class="absolute rounded-full bg-black duration-75 md:h-3 md:w-3 pupil transition-transform 2xl:h-4 2xl:w-4 h-4 sm:h-2 sm:w-2 w-4"></div>
              </div>
              <div
          ...
          <div
            class="items-center justify-center w-full hidden border-b-2 border-black border-t-2 feature-text py-4 sm:flex">
            <p
              class="cursor-default select-none font-light md:text-2xl 2xl:text-4xl colored heading-1 lg:text-3xl scale-y-250 sm:text-xl text-lg whitespace-nowrap -mt-3 2xl:pb-4 2xl:pt-3 capitalize lg:mt-0 lg:pb-1 pb-0 pt-1 sm:-mt-4 tracking-widest"
              data-w-id="creative">
              <span class="letterColor">d</span><span class="letterColor">E</span><span class="letterColor">s</span><span class="letterColor">i</span><span class="letterColor">g</span><span class="letterColor">n</span><span class="letterColor">e</span><span class="letterColor">r</span>
              <span class="letterColor">&</span>
              <span class="letterColor">d</span><span class="letterColor">e</span><span class="letterColor">v</span><span class="letterColor">e</span><span class="letterColor">l</span><span class="letterColor">o</span><span class="letterColor">p</span><span class="letterColor">E</span><span class="letterColor">r</span>
            </p>
          </div>
        </div>
      </section>
      <div
        class="flex justify-start border-black border-y-2 flex-col items-start pl-10 py-4 sm:hidden">
      ...
      <section
        class="flex items-center justify-center py-12 sm:h-[30vh] sm:py-0 w-full"
        id="menue">
        <div class="w-full border-b-2 border-black border-t-2 about-box">
          <div
            ...
            <a
              ...
              <span
                class="flex items-center justify-center transition-all absolute duration-500 ease-out group-hover:opacity-100 group-hover:translate-y-0 inset-0 md:scale-y-150 opacity-0 text-[#b3ac9e] transform translate-y-2 uppercase xl:scale-y-200">about
              </span>
            </a><a
              href="#scroll-content-skills"
              class="px-2 md:px-8 border-black border-l-2 group inline-block md:py-2 overflow-hidden py-1 relative sm:px-6 text-[3f3b37] xl:px-10 xl:py-3">
              <p
                class="uppercase duration-500 ease-out md:scale-y-150 transform transition-all xl:scale-y-200 group-hover:-translate-y-2 group-hover:opacity-0 group-hover:scale-95">
                skills
              ...
              <span
                class="flex items-center justify-center transition-all absolute duration-500 ease-out group-hover:opacity-100 group-hover:translate-y-0 inset-0 md:scale-y-150 opacity-0 text-[#b3ac9e] transform translate-y-2 uppercase xl:scale-y-200">skills
              </span>
            </a><a
              href="#scroll-content-project"
              class="px-2 md:px-8 border-black border-l-2 group inline-block md:py-2 overflow-hidden py-1 relative sm:px-6 text-[3f3b37] xl:px-10 xl:py-3">
              <p
                class="uppercase duration-500 ease-out md:scale-y-150 transform transition-all xl:scale-y-200 group-hover:-translate-y-2 group-hover:opacity-0 group-hover:scale-95">
                projects
              ...
              <span
                class="flex items-center justify-center transition-all absolute duration-500 ease-out group-hover:opacity-100 group-hover:translate-y-0 inset-0 md:scale-y-150 opacity-0 text-[#b3ac9e] transform translate-y-2 uppercase xl:scale-y-200">projects
              </span>
            </a><a
              href="#contact"
  ...
  <section class="flex flex-col w-full overflow-hidden" id="profile">
    <div
      ...
      <div
        ...
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span><span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">profile</span><span class="px-2 md:px-4">-</span>
    ...
    <div class="pl-10 md:my-24 md:pl-32 my-20">
      ...
      <p
        class="uppercase cursor-default font-light select-none text-xl md:text-2xl pt-4">
    ...
    <div
      ...
      <div
        ...
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span><span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
        <span class="px-2 md:px-4">skills</span><span class="px-2 md:px-4">-</span>
  ...
  <section class="w-full relative snap-start" id="skills">
    <div
      ...
      <div
        class="cursor-default select-none lg:leading-snug overflow-hidden tracking-widest"
        id="creative">
      ...
      <div class="relative" id="hero-container">
        <img
          alt="Hero Image"
          class="md:w-72 w-2/3 xl:w-80"
          src="./img/image_2025-05-04_19-14-04.webp"
          id="hero-img" />
        <div
          ...
          <div
            class="absolute rounded-full bg-black duration-75 md:h-3 md:w-3 pupil transition-transform h-3 w-3"></div>
        </div>
        <div
  ...
  <div
    class="w-full overflow-hidden h-14 md:h-20 top-0 backgroundColorAllgray"
    id="scroll-pin">
    <div
      class="flex items-center h-full whitespace-nowrap will-change-transform md:text-7xl text-3xl text-[#3f3b37]"
      id="scroll-content-project"
      data-tx="0">
      ...
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span><span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">project</span><span class="px-2 md:px-4">-</span>
  ...
  <section
    class="w-full relative overflow-hidden backgroundColorAllbrown"
    id="projects">
    <div
      class="w-full font-normal py-14 sm:py-28 sm:text-5xl text-2xl text-[#fcfcf3]">
      <div
        ...
        <div class="absolute z-0 inset-0 bgRedProject pointer-events-none">
          <div
            class="w-full transition-all absolute backgroundColorAllRed duration-1000 ease-out h-0 left-0 top-1/2 -translate-y-full bg-top origin-bottom"></div>
          <div
            class="w-full transition-all absolute backgroundColorAllRed duration-1000 ease-out h-0 left-0 top-1/2 -translate-y bg-bottom origin-top"></div>
        </div>
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">Logo </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">Professional logo design reflects the brand's values and identity
            and plays a role in creating a lasting image in the minds of the
            audience. Consistent use of the logo leads to stability and faster
            brand recognition.</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[230px] min-h-[230px]">
          <div class="w-full relative group overflow-x-auto">
            <div
              class="w-full gap-1 grid grid-flow-col grid-rows md:gap-3 md:grid-rows-2 min-w-max">
              <div class="flex items-center justify-center">
                <img
                  alt="Single Image"
                  class="cursor-pointer 2xl:h-[220px] 2xl:w-[220px] border duration-300 grayscale h-[200px] hover:grayscale-0 hover:opacity-100 md:h-[155px] md:w-[155px] object-cover opacity-60 sm:h-[200px] sm:w-[200px] transition w-[200px] xl:h-[175px] xl:w-[175px]"
                  src="./img/Logo-(1).webp"
                  data-group="single1"
                  data-index="0"
                  loading="lazy" />
      ...
      <div
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">Social media </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">Social media has become a captivating battleground for brands,
            where creativity and communication intertwine. With diverse and
            engaging content, brands can narrate their stories and quickly
            capture the attention of their audience. In today's digital world,
            an effective presence on social media means creating a loyal and
            active community around your brand.</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[200px] min-h-[200px]">
          <div class="w-full relative group overflow-x-auto">
            <div
              class="w-full gap-1 grid grid-flow-col grid-rows md:gap-3 md:grid-rows-2 min-w-max">
              <div class="flex items-center justify-center">
      ...
      <div
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">Banner and Billboard </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">Billboards are powerful advertising tools that allow businesses to
            convey their messages to a wide range of audiences in public spaces.
            The strategic placement of billboards in high-traffic areas ensures
            immediate and lasting brand attention. This type of advertising,
            with its high visual impact, provides an excellent opportunity to
            increase awareness and engage with audiences.</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[230px] min-h-[230px]">
          <div class="w-full relative group overflow-x-auto">
      ...
      <div
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">Ui / UX design </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">Website design is the art of crafting a digital experience that
            showcases a brand's identity in an engaging and efficient manner. In
            the business world, having a professional website not only helps
            introduce products and services but also plays a crucial role in
            attracting and retaining customers, increasing engagement, and
            enhancing the purchasing experience. As a key tool for business
            success, website design offers vast opportunities for growth and
            market impact."</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[230px] min-h-[230px]">
      ...
      <div
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">Office set </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">In a competitive and saturated marketplace, I elevate your brand
            with data-driven insights and innovative storytelling. I craft
            compelling narratives that not only capture your audience's
            attention but also drive conversions and foster brand loyalty. Every
            message I deliver is tailored to your unique brand identity,
            solidifying your position as a market leader.</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[230px] min-h-[230px]">
          <div class="w-full relative group overflow-x-auto">
      ...
      <div
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">Poster </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">A creative and engaging design not only captures attention but also
            establishes a deeper connection with the audience, helping the
            message to linger in their minds.</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[230px] min-h-[230px]">
          <div class="w-full relative group overflow-x-auto">
      ...
      <div
        ...
        <div class="z-10 relative ProjectAll pl-10">
          <span
            class="z-10 relative block duration-1000 ease-out main-text px:10 sm:px-28 transition-opacity">packaging </span><span
            class="flex items-center absolute ease-out inset-0 opacity-0 duration-1000 font-extralight justify-start project-description px:12 sm:px-28 text-xs transition-opacity z-10">Professional packaging is the key to protecting a product and
            capturing a customer's attention. With an attractive and functional
            design, a product can be differentiated from competitors and create
            a sense of quality and trust in customers. In addition, proper
            packaging makes transportation and storage easier and effectively
            conveys important product information...</span>
        </div>
        <div
          class="flex items-center justify-center overflow-hidden ease-in-out relative 2xl:group-[.active]:max-h-[485px] 2xl:min-h-[485px] bg-[3f3b37] duration-700 h-fit hidden max-h-0 md:group-[.active]:max-h-[355px] md:min-h-[355px] md:pt-3 project-extra pt-1 sm:group-[.active]:max-h-[230px] sm:min-h-[230px] transition-all w-full xl:group-[.active]:max-h-[395px] xl:min-h-[395px] z-20 group-[.active]:max-h-[230px] min-h-[230px]">
          <div class="w-full relative group overflow-x-auto">
    ...
    <div
      class="flex items-center justify-center inset-0 bg-black bg-opacity-80 fixed hidden text-center\ z-50"
      id="lightbox">
      <span
        class="cursor-pointer absolute right-6 text-3xl text-white top-4"
        id="lightbox-close"><svg
        ...
        </svg> </span><button class="absolute text-white text-4xl left-4" id="lightbox-prev">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          height="80"
      ...
      <img
        alt="preview"
        class="object-contain max-h-[90vh] max-w-[90vw] shadow-2xl"
        src=""
        id="lightbox-img" />
      <button class="absolute text-white text-4xl right-4" id="lightbox-next">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          height="80"
  ...
  <div class="w-full overflow-hidden h-14 md:h-20 top-0" id="scroll-pin">
    <div
      class="flex items-center h-full whitespace-nowrap will-change-transform md:text-7xl text-4xl text-[3f3b37]"
      id="scroll-content"
      data-tx="0">
      ...
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span><span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
      <span class="px-2 md:px-4">contact</span><span class="px-2 md:px-4">-</span>
  ...
  <section
    ...
    id="contact">
    <div
      class="flex items-center justify-center flex-col w-full max-w-4xl my-8 px-4">
      <img
        alt="Design Image"
        class="object-contain max-w-md w-1/3"
        src="./img/image_2025-05-04_19-13-52.webp" />
      <p
        class="cursor-default select-none font-light text-center mt-4 sm:text-3xl text-md">
        - Your next great design begins here -
      </p>
      <p
        class="cursor-default select-none text-center mt-4 sm:text-3xl text-md">
        send me a message!
      </p>
    </div>
    <div class="flex justify-center w-full max-w-4xl pb-16 space-x-4">
      <a
        href="https://wa.me/989159053461"
        ...
        href="https://t.me/GoharHosseinzadeh"
        ...
        href="http://www.linkedin.com/in/gohar-hosseinzadeh-nazeri"
        class="flex items-center justify-center overflow-hidden ease-in-out relative bg-[#3f3b37] border border-transparent duration-500 hover:animate-shake hover:bg-[#d13318] magnetic rounded-full transition-[border-color,border-width] text-white"><span
          class="absolute duration-1000 transition-all bg-radial-red inset-0 opacity-0 scale-0 z-0"></span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        href="https://www.instagram.com/Gohar.graphic/"
        class="flex items-center justify-center overflow-hidden ease-in-out relative bg-[#3f3b37] border border-transparent duration-500 hover:animate-shake hover:bg-[#d13318] magnetic rounded-full transition-[border-color,border-width] text-white"><span
          class="absolute duration-1000 transition-all bg-radial-red inset-0 opacity-0 scale-0 z-0"></span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        href="mailto:goharhosseinzadehnazeri@gmail.com"
        class="flex items-center justify-center overflow-hidden ease-in-out relative bg-[#3f3b37] border border-transparent duration-500 hover:animate-shake hover:bg-[#d13318] magnetic rounded-full transition-[border-color,border-width] text-white"><span
          class="absolute duration-1000 transition-all bg-radial-red inset-0 opacity-0 scale-0 z-0"></span>
        <svg
          xmlns="http://www.w3.org/2000/svg"
  ...
  <footer>
    <a href="#hero">
      <div
        class="cursor-pointer overflow-hidden relative w-full backgroundColorAllbrown h-10 md:h-16"
        id="scrollPinFoter">
        <div
          class="flex items-center h-full whitespace-nowrap will-change-transform md:text-5xl text-2xl text-[fcfcf3]"
          id="scroll-footer">
